...
CONFIG = {
    ...
    "save_path": os.path.join(OUTPUT_ROOT, "cumulative_crossers_10um_CT_new_unfiltered.pdf"),
    "save_path_median_iqr_time": os.path.join(OUTPUT_ROOT, "Fig2_panel_e_median_IQR_over_time_CT_unfiltered.pdf"),
    "export_csv": None,
