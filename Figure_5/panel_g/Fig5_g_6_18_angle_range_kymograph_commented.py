...
def main():
    config = {
        ...
        "input_relpath": "6.5h_18h",

        # Output PDF filename inside Output_folder/
        "output_filename": "Fig5_panel_g_6_18.pdf",
        ...
        "highlight_regions": [[37, 50], [86, 99], [135, 148], [184, 197], [233, 246], [282, 295], [331, 344]],
        ...
        "shift_from_frame": 0,  # frame index at which the jump occurs (0-based)
